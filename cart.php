...
<body>
    ...
    <div class="cart-container">
        ...
        <div class="cart-area show-for-large">
            <form action="">
                <div class="cart-list">
                    <div class="cart">
                        <label for="check1">
                        ...
                        <div class="close"><img src="./img/cart-close.svg"></div>
                    </div>
                    <div class="cart">
                        <label for="check2">
                            <div class="check-area">
        ...
        <div class="cart-area hide-for-large">
            <form action="">
                <div class="cart-list">
                    <div class="cart">
                        <label for="check1">
        ...
        <div class="final show-for-large flex-container">
                ...
                <a href="./step-1.php">
                    <svg id="b" data-name="圖層 2" xmlns="http://www.w3.org/2000/svg" width="72.46" height="33.6" viewBox="0 0 72.46 33.6">
                        <g id="c" data-name="圖層 2">
                            <polygon points="58.7 0 0 0 0 33.6 58.7 33.6 72.46 16.8 58.7 0" style="fill: #9e3147;" />
                            <g>
        ...
        <div class="ask-area hide-for-large">
            <a href="./step-1.php">
                <svg id="b" data-name="圖層 2" xmlns="http://www.w3.org/2000/svg" width="72.46" height="33.6" viewBox="0 0 72.46 33.6">
                    <g id="c" data-name="圖層 2">
                        <polygon points="58.7 0 0 0 0 33.6 58.7 33.6 72.46 16.8 58.7 0" style="fill: #9e3147;" />
