<div class="fix-mobile hide-for-large" id="list">
    <ul class="list-area">
        <li class="home">
            <a href="./index.php">
        ...
        <li class="search">
            <a href="search.php">
                <svg id="b" data-name="圖層 2" xmlns="http://www.w3.org/2000/svg" width="19.25" height="19.43" viewBox="0 0 19.25 19.43">
                    <g id="c" data-name="文字">
                        <g>
                            <circle class="d" cx="9.04" cy="9.04" r="8.33" />
                            <line class="d" x1="14.83" y1="15.02" x2="18.75" y2="18.94" />
                        </g>
                    </g>
                </svg>
...
<script>
    $('.inquiry').click(function() {
        $('.no-link').toggleClass('is-not-show');
        $('.link').toggleClass('is-show');
        $('.cart-link').toggleClass('is-show');
        $('.arrow').toggleClass('is-show');
    });
