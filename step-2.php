...
<body>
    ...
    <div class="cart-step">
        <div class="successWrap">
            <div class="success">
                <div class="check">
                    <svg id="b" data-name="圖層 2" xmlns="http://www.w3.org/2000/svg" width="58.81" height="58.81" viewBox="0 0 58.81 58.81">
                        <g id="c" data-name="圖層 2">
                            <rect x="0" y="0" width="58.81" height="58.81" rx="29.4" ry="29.4" style="fill: #e95529;" />
